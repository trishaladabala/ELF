...
def finetune_toy_model(embeddings, token_ids, vocab_size, ckpt_name):
    print("=" * 60)
    print(f"R5 — Training {ckpt_name} (Decoupled Architecture)")
    print("=" * 60)
...
def main():
    ...
    finetune_toy_model(embeddings, token_ids, vocab_size, "testR5_model_decoupled.pt")
